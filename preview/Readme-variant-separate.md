> **Preview variant: separate** : stewardship text, logo row, and CTA banner as separate elements. Not the live README.
...
[![Need help solving a complex use case?](doctr-need-help-swapped-logos.png)](https://www.text2knowledge.de/de/portfolio/doctr-on-prem-ocr)
