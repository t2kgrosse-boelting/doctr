> **Preview variant: combined** : stewardship text, logos, and CTA merged into a single banner image. Not the live README.
...
[![docTR was originally created by Mindee and is now actively developed by t2k GmbH : Need help solving a complex use case?](preview-example.png)](https://www.text2knowledge.de/de/portfolio/doctr-on-prem-ocr)
